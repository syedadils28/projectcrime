...
<body>
    <div class="page-wrapper">
        ...
        <div class="login-selector">
            ...
            <button class="selector-btn" id="btn-other" onclick="window.location.href = 'police_login.php'">
                <i class="bx bxs-building-house"></i>
                Police Login
            </button>
             <button class="selector-btn active" id="btn-other" onclick="window.location.href = 'admin_login.php'">
                <i class="bx bxs-building-house"></i>
                Admin Login
            </button>
        ...
        <div class="auth-wrapper">
            ...
            <div class="credentials-panel signin">
                <h2 class="slide-element">Admin Login</h2>
                <form action="#">
