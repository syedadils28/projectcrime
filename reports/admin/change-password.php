...
if($_SERVER['REQUEST_METHOD']==='POST'){
    ...
    $id=$_SESSION['adminid'];
    $chk=mysqli_fetch_row(mysqli_query($con,"SELECT id FROM tbl_admin WHERE id=$id AND Password='$cur'"));
    if(!$chk){
        ...
        mysqli_query($con,"UPDATE tbl_admin SET Password='".md5($new)."' WHERE id=$id");
  ...
  <div class="card-body">
    ...
    <form method="POST">
      <table style="width:100%;border-collapse:collapse;">
        <tr>
          <td style="padding:9px 0;width:200px;font-size:13px;color:#555;">Current Password <span class="req">*</span></td>
          <td style="padding:9px 0;"><input type="password" name="current" class="form-control" required></td>
        </tr>
        <tr>
          <td style="padding:9px 0;font-size:13px;color:#555;">New Password <span class="req">*</span></td>
          <td style="padding:9px 0;"><input type="password" name="newpass" class="form-control" required minlength="6"></td>
        </tr>
        <tr>
          <td style="padding:9px 0;font-size:13px;color:#555;">Confirm Password <span class="req">*</span></td>
          <td style="padding:9px 0;"><input type="password" name="confirm" class="form-control" required></td>
        </tr>
        <tr>
          <td></td>
